...
sys_sigreturn(void)
{
  struct proc *p = myproc();
  p->handler_in = 0;
  // p->trapframe->epc = p->epc_saved;
  // p->trapframe->sp = p->sp_saved;
  // p->trapframe->ra = p->ra_saved;
  // p->trapframe->s0 = p->s0_saved;
  // p->trapframe->a5 = p->a5_saved;
  // p->trapframe->a4 = p->a4_saved;
  // p->trapframe->a0 = p->a0_saved;
  // p->trapframe->s1 = p->s1_saved;
